...
// Imports: Init Mathlib.Analysis.InnerProductSpace.l2Space Mathlib.Data.Real.GoldenRatio Mathlib.Topology.Instances.ENNReal Mathlib.Data.Nat.Prime Mathlib.Analysis.SpecialFunctions.Complex.Log Mathlib.Topology.Algebra.InfiniteSum.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Topology_Instances_ENNReal(uint8_t builtin, lean_object*);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_Instances_ENNReal(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
